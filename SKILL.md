...
description: Create formal academic research papers meeting IEEE and ACM publication standards. Use when writing research papers for conferences/journals, including survey papers, experimental papers, methodology papers, or any academic manuscript requiring proper structure, formatting, citations, and academic writing style. Supports IEEE and ACM formats with comprehensive coverage of all standard sections from abstract to references.
---
...
See [references/ieee_formatting_specs.md](references/ieee_formatting_specs.md) and [references/acm_formatting_specs.md](references/acm_formatting_specs.md) for complete specifications.
...
See [references/writing_style_guide.md](references/writing_style_guide.md) for detailed academic writing conventions.
...
- [references/writing_style_guide.md](references/writing_style_guide.md): Detailed academic writing conventions
- [references/ieee_formatting_specs.md](references/ieee_formatting_specs.md): Complete IEEE formatting specifications
- [references/acm_formatting_specs.md](references/acm_formatting_specs.md): Complete ACM formatting specifications

### Assets

- assets/ieee_template.tex: IEEE LaTeX template
- assets/acm_template.tex: ACM LaTeX template
